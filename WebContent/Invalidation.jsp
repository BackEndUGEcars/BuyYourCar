		...
		<div id="content">
			<div class="container-fluid">
				<div class="wrapper">
					...
					<h3 style="text-align: center; color: #ccc;">An error occurred during payment process, please verify <br> you entered login/password correctly and if there is a sufficient <br>amount on your bank account</h3>
					<div
